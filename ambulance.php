<?php
	...
	*/
	...
	?>({
			...
			"items":[
<?php
		//Alle ambulance meldingen ophalen uit de database van de server
			...
			//Alle laatste 30 ambulance meldingen zijn opgehaald. Connectie met mysql server kan gesloten worden
			mysql_close($con);
?>] 
})<?php
	if(!isset($_GET["jsoncallback"])){
